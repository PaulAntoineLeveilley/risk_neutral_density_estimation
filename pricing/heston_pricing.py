...
def heston_prices(
    ...
    """
    return S * P(
        1, S, T, V, K, r, kappa, theta, lambd, rho, sigma, upper_bound
    ) - K * np.exp(-r * T) * P(
        2, S, T, V, K, r, kappa, theta, lambd, rho, sigma, upper_bound
    )
...
def rnd_heston(
    ...
    def integrand(phi):
        return (
            ...
            * f(2, S, V, T, r, kappa, theta, lambd, rho, sigma, phi)
        ).real
...
def P(
    ...
    def integrand(phi):
        return (
            ...
            * f(i, S, V, T, r, kappa, theta, lambd, rho, sigma, phi)
            / (1j * phi)
        ).real
